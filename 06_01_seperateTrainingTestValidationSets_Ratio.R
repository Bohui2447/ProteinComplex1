...
#### prepare data
if(file.exists("../Rdata_localPC/6exprAllDivede_ratio.Rdata") &
   file.exists("../Rdata_localPC/7TrainMeanSD_ratio.Rdata")){
  cat("load ../Rdata_localPC/7TrainMeanSD_ratio.Rdata")
  load("../Rdata_localPC/7TrainMeanSD_ratio.Rdata")
} else {
  ...
  save(trainNorm, trainlables, testNorm, testlables, valNorm, vallabels, 
       file =  "../Rdata_localPC/6exprAllDivede_ratio.Rdata")
  save(meanTrain, sdTrain,
       file =  "../Rdata_localPC/7TrainMeanSD_ratio.Rdata")
}
