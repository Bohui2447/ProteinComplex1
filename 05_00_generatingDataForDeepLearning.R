...
if(file.exists("../Rdata_localPC/5exprLabel.Rdata")){
  cat("load ../Rdata_localPC/5exprLabel.Rdata")
  ...
  # the number of negative set is same to that of positive set
  ...
  save(exprLabel, file = "../Rdata_localPC/5exprLabel.Rdata") ### this will be different from the original data, because the random seed was not set.
