...
if(FALSE){
  ...
  dir.create(paste0(path, "/", "11_01_logFileFolder"))
  logFile = paste0(path, "/", "11_01_logFileFolder", "/11_01_logfile_seed_", seed, ".log")
  
  rTimeHour = 4
  memoryG = 50
  # rTimeHour = 48, memoryG = 80,
  res = rQsub(path = path, rFile = Rfile, jobName = paste0("jobSeed_", seed),
              threaded = 1, rTimeHour = rTimeHour, memoryG = memoryG,
...
for(ni in 1:N){
  ...
  if (!dir.exists("../figs/11_01/precisionRecall")){
    dir.create("../figs/11_01/precisionRecall", recursive = T)
  }
  fileName = paste0("../figs/11_01/precisionRecall/11_01_model_", ni, 
                    "_seed", seed,"_",
  ...
  if (!dir.exists("../figs/11_01/ROC")){
    dir.create("../figs/11_01/ROC", recursive = T)
  }
  fileName = paste0("../figs/11_01/ROC/11_01_model_", ni, 
                    "_seed", seed,"_",
                    params$units1[ni], "_", params$dropOut1[ni],"_", 
                    params$units2[ni], "_", params$dropOut2[ni], "_", 
                    params$units3[ni],"_", params$dropOut3[ni])
  ...
  # plot history
  if (!dir.exists("../figs/11_01/history")){
    dir.create("../figs/11_01/history", recursive = T)
  }
  fileName = paste0("../figs/11_01/history/11_01_model_", ni, 
                    "_seed", seed,"_",
                    params$units1[ni], "_", params$dropOut1[ni],"_", 
                    params$units2[ni], "_", params$dropOut2[ni], "_", 
                    params$units3[ni],"_", params$dropOut3[ni])
  ...
  if (!dir.exists("../Rdata/ModelSave/11_01/model/")){
    dir.create("../Rdata/ModelSave/11_01/model/", recursive = T)
  }
  # save model
  # if (F1_value > 0.49){
    if (F1_value > 0.4){
    fileName = paste0("../Rdata/ModelSave/11_01/model/11_01_model_", ni, 
                      "_seed", seed,"_",
                      params$units1[ni], "_", params$dropOut1[ni],"_", 
                      params$units2[ni], "_", params$dropOut2[ni], "_", 
                      params$units3[ni],"_", params$dropOut3[ni])
    ...
    # save parameters
    if (!dir.exists("../Rdata/ModelSave/11_01/parameter/")){
      dir.create("../Rdata/ModelSave/11_01/parameter/", recursive = T)
    }
    fileName = paste0("../Rdata/ModelSave/11_01/parameter/11_01_model_", ni, 
                      "_seed", seed,"_",
                      params$units1[ni], "_", params$dropOut1[ni],"_", 
                      params$units2[ni], "_", params$dropOut2[ni], "_", 
                      params$units3[ni],"_", params$dropOut3[ni])
