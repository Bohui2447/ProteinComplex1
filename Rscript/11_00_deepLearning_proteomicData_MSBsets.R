...
if(FALSE){
  ...
  dir.create(paste0(path, "/", "11_00_logFileFolder"))
  logFile = paste0(path, "/", "11_00_logFileFolder", "/11_00_logfile_seed_", seed, ".log")
  res = rQsub(path = path, rFile = Rfile, jobName = paste0("jobSeed_", seed),
              threaded = 1, rTimeHour = 48, memoryG = 80,
...
for(ni in 1:N){
  ...
  if (!dir.exists("../figs/11_00/precisionRecall")){
    dir.create("../figs/11_00/precisionRecall", recursive = T)
  }
  fileName = paste0("../figs/11_00/precisionRecall/11_00_model_", ni, 
                    "_seed", seed,"_",
  ...
  if (!dir.exists("../figs/11_00/ROC")){
    dir.create("../figs/11_00/ROC", recursive = T)
  }
  fileName = paste0("../figs/11_00/ROC/11_00_model_", ni, 
                    "_seed", seed,"_",
                    params$units1[ni], "_", params$dropOut1[ni],"_", 
                    params$units2[ni], "_", params$dropOut2[ni], "_", 
                    params$units3[ni],"_", params$dropOut3[ni])
  ...
  # plot history
  if (!dir.exists("../figs/11_00/history")){
    dir.create("../figs/11_00/history", recursive = T)
  }
  fileName = paste0("../figs/11_00/history/11_00_model_", ni, 
                    "_seed", seed,"_",
                    params$units1[ni], "_", params$dropOut1[ni],"_", 
                    params$units2[ni], "_", params$dropOut2[ni], "_", 
                    params$units3[ni],"_", params$dropOut3[ni])
