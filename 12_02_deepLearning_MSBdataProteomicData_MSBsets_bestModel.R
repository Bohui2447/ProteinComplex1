...
if(FALSE){
  ...
  # param1 = seed = 507291
  dir.create(paste0(path, "/", "12_02_logFileFolder"))
  logFile = paste0(path, "/", "12_02_logFileFolder", "/12_02_logfile_seed_", seed, ".log")
...
# for(ni in N:1){
  ...
  fileName = paste0("../figs/", folderBase, "/precisionRecall/12_02_model_", ni, 
                    "_seed", seed,"_",
  ...
  fileName = paste0("../figs/", folderBase, "/ROC/12_02_model_", ni, 
                    "_seed", seed,"_",
                    params$units1[ni], "_", params$dropOut1[ni],"_", 
                    params$units2[ni], "_", params$dropOut2[ni], "_", 
                    params$units3[ni],"_", params$dropOut3[ni])
  ...
  fileName = paste0("../figs/", folderBase, "/history/12_02_model_", ni, 
                    "_seed", seed,"_",
                    params$units1[ni], "_", params$dropOut1[ni],"_", 
                    params$units2[ni], "_", params$dropOut2[ni], "_", 
                    params$units3[ni],"_", params$dropOut3[ni])
  ...
  if (F1_value > 0.66){
    # if (F1_value > 0.5){
    fileName = paste0("../Rdata/ModelSave/", folderBase, "/model/12_02_model_", ni, 
                      "_seed", seed,"_",
                      params$units1[ni], "_", params$dropOut1[ni],"_", 
                      params$units2[ni], "_", params$dropOut2[ni], "_", 
                      params$units3[ni],"_", params$dropOut3[ni])
    ...
    fileName = paste0("../Rdata/ModelSave/", folderBase, "/parameter/12_02_model_", ni, 
                      "_seed", seed,"_",
                      params$units1[ni], "_", params$dropOut1[ni],"_", 
                      params$units2[ni], "_", params$dropOut2[ni], "_", 
                      params$units3[ni],"_", params$dropOut3[ni])
